# Assignment 5: adventurerEffect, smithyEffect, council_roomEffect, villageEffect, great_hallEffect
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    ...
    case village:
      villageEffect(card, choice1, choice2, choice3, state, handPos, bonus);
      return 0;
    ...
    case great_hall:
      great_hallEffect(card, choice1, choice2, choice3, state, handPos, bonus);
