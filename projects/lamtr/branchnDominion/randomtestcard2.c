...
int main()
{
	...
	printf("hand count = %d, expected = %d\n", testG.handCount[thisPlayer], G.handCount[thisPlayer] + 4 - discarded);  		// 4 is replaced by myRandNum
	printf("deck count = %d, expected = %d\n", testG.deckCount[thisPlayer], G.deckCount[thisPlayer] - 4 + shuffledCards);	// 4 is replaced by myRandNum
